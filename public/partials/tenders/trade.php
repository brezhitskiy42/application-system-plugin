...
<div class="tenders__as">
  <div class="trade__as">
      ...
      <form id="trade">
        ...
        <div class="block__as">
          <div class="tender-type__as">
            <a href="<?php echo get_permalink( get_page_by_path( 'tender/trade' ) ); ?>" class="active__as">Покупка</a>
          ...
          <?php $all_posts = get_posts( array( 'numberposts' => -1, 'post_type' => 'trade' ) ); ?>
    ...
    <div class="posts__as">
      <?php
        $posts = get_posts( array( 'numberposts' => 15, 'post_type' => 'trade' ) );
    ...
    <button type="button" data-post-type="trade" class="load-more__as<?php if ( $total_posts < 15 ) echo ' hide__as'; ?>">Загрузить еще</button>

...
<div class="addadv-parts__as">
  <form id="addadv-parts__as" method="post" action="<?php echo admin_url( 'admin-post.php' ); ?>">
    ...
    <div class="item__as">
      <div class="content__as">
        ...
        <div class="btns__as tender-type__as">
          ...
          <button type="button" class="active__as" data-block=".addadv-parts__as">Запчасти</button>
      ...
      <div class="content__as">
        ...
        <div class="preset-links__as">
          <?php foreach ( $parts_categories_parents_presets as $parts_category ): ?>
            <span class="link__as" data-id="<?php echo $parts_category->term_id; ?>" data-select=".main-cat__as"><?php echo $parts_category->name; ?></span>
          <?php endforeach; ?>
        </div>
      </div>
      <div class="sidebar__as">
        <div class="text__as">Выберите один, главный тип запчастей, который вам необходим. Если вам нужно несколько типов техники, то вы можете их перечислить в описании заявки.</div>
      </div>
    </div>
    <?php

...
<div class="addadv-trade__as">
  <form id="addadv-trade__as" method="post" action="<?php echo admin_url( 'admin-post.php' ); ?>">
    ...
    <div class="item__as">
      <div class="content__as">
        ...
        <div class="btns__as tender-type__as">
          <button type="button" class="active__as" data-block=".addadv-trade__as">Покупка</button>
        ...
        <select class="cat__as" name="as_cat" data-placeholder="Тип оборудования/техники" data-validation="required">
          ...
          <optgroup label="Популярные">
            <?php foreach ( $trade_categories_parents_popular as $trade_category ): ?>
              <option value="<?php echo $trade_category->term_id; ?>"><?php echo $trade_category->name; ?></option>
            <?php endforeach; ?>
          </optgroup>
          <optgroup label="Все">
        ...
        <select class="subcat__as" name="as_subcat" data-placeholder="Категория" disabled>
          ...
          <optgroup label="Популярные" class="popular__as">
            <?php foreach ( $trade_categories_childs_popular as $trade_category ): ?>
              <option value="<?php echo $trade_category->term_id; ?>" data-parent="<?php echo $trade_category->parent; ?>"><?php echo $trade_category->name; ?></option>
            <?php endforeach; ?>
          </optgroup>
    ...
    <div class="item__as item-6__as pb10__as">
      <div class="content__as">
        ...
        <input type="text" placeholder="Введите заголовок заявки" name="as_title" data-validation="length" data-validation-length="1-100" autocomplete="fuck" autocomplete="fuck">
      </div>
      <div class="sidebar__as">
